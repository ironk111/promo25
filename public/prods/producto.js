                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <a href="${producto.ig}" class="btn btn-secondary rounded-pill" target="_blank" rel="noopener noreferrer"><img src="/public/img/instagram-icon.svg" class="img-fluid" style="width: 32px; height: 32px;"></a>
                                </div>
                            </div>
                        </div>
                    </div>
